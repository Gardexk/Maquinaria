 ...
 * @author Erick
 */
public class IngresarOperario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Crear nuevo operario");
    ...
    private void registrartxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registrartxtMouseClicked
        ...
        if(txt_direccion.getText().equals("")||txt_email.getText().equals("")||txt_id.getText().equals("")||txt_nombre.getText().equals("")||txt_telefono.getText().equals("")){
            ...
            if (email.endsWith("@gmail.com") || email.endsWith("@unach.mx") || email.endsWith("@hotmail.com")) {
                ...
                if (!controlOperario.existeOperario(txt_id.getText().trim())) {

                    try {

                        operario.setIdOperario(Integer.parseInt(txt_id.getText().trim()));
                        operario.setNomOperario(txt_nombre.getText().trim());
                        operario.setDireccion(txt_direccion.getText().trim());
                        operario.setTelefono(txt_telefono.getText().trim());
                        operario.setCorreo(txt_email.getText().trim());

                        if (controlOperario.guardar(operario)) {
                            JOptionPane.showMessageDialog(null, "Registro Guardado");
                            Limpiar();
                        } else {
                            JOptionPane.showMessageDialog(null, "Error al guardar el operario");
                        }
